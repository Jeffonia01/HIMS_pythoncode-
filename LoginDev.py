...
class Locators:
     ## Login
    username = "developer@plenome.com"
    password = "Dev@123"
    url = "http://13.200.35.19/ehospitos/demo/smart_hospital_src/site/login"
    patient = "Venkat"
    ...
    Languages_Azerbaijan = "//label[@for='ms-opt-23']/input[@type='checkbox' and @title='Azerbaijan']"
    ...
    Specialist_vascular = '//input[@title="Cardiologyist"]'
    ...
    Sick_Leave = '//input[@name="alloted_leave_1"]'
    Casual_Leave = '//input[@name="alloted_leave_3"]'
...
class Venkat(Data, Locators):
    ...
    def Human_resource(Human_resource):
        try:
            ...
            sleep(2)
            Human_resource.driver.find_element(By.XPATH, Human_resource.Date_Of_Birth).send_keys("123") ###
            sleep(2)
            Human_resource.driver.find_element(By.XPATH, Human_resource.Password).clear()
            sleep(2)
            Human_resource.driver.find_element(By.XPATH, Human_resource.Password).send_keys("123")  ###
            sleep(2)
            ...
            sleep(2)
            Human_resource.driver.find_element(By.XPATH, Human_resource.Bank_IFSC_Code).send_keys("SBI") ##
            sleep(2)

...
class Data:
    username = "indianthatha@gmail.com"
    password = "Thatha@123"
...
class Locators:
    ...
    ## Hospitals_details
    Setup = "//a[contains(@href,'https://qa-hms.plenome.com/')]/span[text()='Setup']" 
    Setup_Settings ='//a[@href="https://qa-hms.plenome.com/schsettings/"]'
    ...
    Setup_Humanresources = '//a[@href="https://qa-hms.plenome.com/admin/leavetypes"]'
    Setup_HR_Specilization ='//a[@href="https://qa-hms.plenome.com/admin/specialist"]'
    ...
    Setup_HR_Designation = '//a[@href="https://qa-hms.plenome.com/admin/designation/designation"]'
    ...
    Setup_HR_Department = '//a[@href="https://qa-hms.plenome.com/admin/department"]'
    ...
    Setup_HR_Leave = '//a[@href="https://qa-hms.plenome.com/admin/leavetypes"]'
    ...
    #Human resource
    Human_resources = "//a[@href='https://qa-hms.plenome.com/admin/staff']/span[text()='Human Resource']"

    Add_staff ='//a[@href="https://qa-hms.plenome.com/admin/staff/create"]'
    ...
    Designation_vascular = "//option[@value='125' and normalize-space(text())='Dentist']"
    Department = '//select[@name="department"]'
    Department_vascular = "//option[@value='172' and normalize-space(text())='Ophthalmology']"
    Specialist = "//button[normalize-space(text())='Select Specialist']"
    Specialist_vascular = "//input[@type='checkbox' and @id='ms-opt-2']"
    ...
    Work_Experience = ' //textarea[@id="work_exp"]'
    ...
    Setup_Appointment = '//a[@href="https://qa-hms.plenome.com/admin/onlineappointment/"]'
    


    #Hospital Charges
    Setup_Hopital_Charges = '//a[@href="https://qa-hms.plenome.com/admin/charges"]'
    Unit_Type = '//a[@href="https://qa-hms.plenome.com/admin/unittype"]'
    ...
    Tax_Category = '//a[@href="https://qa-hms.plenome.com/admin/taxcategory"]'
    ...
    Charge_Type = '//a[@href="https://qa-hms.plenome.com/admin/chargetype"]'
    ...
    Charge_Category = '//a[@href="https://qa-hms.plenome.com/admin/chargecategory/charges"]'
    ...
    Charges = '//a[@href="https://qa-hms.plenome.com/admin/charges"]'
    ...
    Charges_Category = '//span[@id="select2-charge_category-container"]'
    Charges_Category_AppointmentCharges = '//option[@value="1" and normalize-space(text())="Appointment"]'
    Charges_Category_OPDmod ='//option[@value="2" and normalize-space(text())="OPD"]'
    Charges_Unit_Type = '//a[@href="https://qa-hms.plenome.com/admin/unittype"]'
    Charges_Unit_Type_Rs = '//button[@class="btn btn-primary btn-sm addunittype add_unit_type_modal"]'
    Charges_Name = '//input[@class="form-control name"]'
    Charges_Std_Amount = '//textarea[@class="form-control description"]'
    Charges_Type_Save = '//button[@class="btn btn-info pull-right"]'
...
class Venkat(Data, Locators):
    ...
    def Human_resource(Human_resource):
        try:
            ...
            sleep(2)
            Human_resource.driver.find_element(By.XPATH, Human_resource.Photo).send_keys("C:\\Users\\ptl03\\Downloads\\Usumaki.jpg")
            sleep(5)
...
if __name__ == "__main__":
    ...
    # Charges_Charge_Type_Appointmentmod = '//option[@value="1" and normalize-space(text())="Appointment"]'
    # Charges_Charge_Type_OPDmod ='//option[@value="2" and normalize-space(text())="OPD"]'
    # Charges_Category = '//select[@class="form-control charge_type"]'
    # Charges_Category_AppointmentCharges = '//option[@value="1" and normalize-space(text())="Appointment"]'
    # Charges_Category_OPDmod ='//option[@value="2" and normalize-space(text())="OPD"]'
    # Charges_Unit_Type = '//a[@href="https://qa-hms.plenome.com/admin/unittype"]'   
    # Charges_Unit_Type_Rs = '//button[@class="btn btn-primary btn-sm addunittype add_unit_type_modal"]'
